...
void drawMerc(HDC hdc, int x, int y) {
    HPEN hpen = CreatePen(PS_SOLID, 5, RGB(148, 0, 211));
    SelectObject(hdc, hpen);
    HBRUSH hbrush = CreateSolidBrush(RGB(255, 255, 255));
    SelectObject(hdc, hpen);
    Ellipse(hdc, 5 + x, 5 + y, 100 + x, 100 + y);
    MoveToEx(hdc, 52 + x, 49 + y, NULL);
    LineTo(hdc, 52 + x, 5 + y);
    MoveToEx(hdc, 52 + x, 49 + y, NULL);
    LineTo(hdc, 20 + x, 80 + y);
    MoveToEx(hdc, 52 + x, 49 + y, NULL);
    LineTo(hdc, 84 + x, 80 + y);
}

void krest(HDC hdc) {
    drawMerc(hdc, 0, 0);
    drawMerc(hdc, 200, 200);
    drawMerc(hdc, 100, 100);
    drawMerc(hdc, 0, 200);
    drawMerc(hdc, 200, 0);
}
