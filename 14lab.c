...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_PAINT:
    {
        ...
        if (type == 0) Image0(hdc, image1_x, image1_y, RGB(194, 24, 7));
        if (type == 1) Image1(hdc, image1_x, image1_y, RGB(194, 24, 7));
        if (type == 2) Image2(hdc, image1_x, image1_y, RGB(194, 24, 7));
        if (type == 3) Image3(hdc, image1_x, image1_y, RGB(194, 24, 7));
        if (type == 4) Image4(hdc, image1_x, image1_y, RGB(194, 24, 7));
        EndPaint(hWnd, &ps);
    }
    break;
    case WM_DESTROY:
